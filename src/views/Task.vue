...
export default {
    ...
    created: async function() {
        ...
        const result = await firestore.getOrderByTakerAddress(this.myAddress, 50, undefined)
    ...
    methods: {
        async loadMore() {
            const result = await firestore.getOrderByTakerAddress(this.myAddress, 50, this.lastDocSnapshot)
